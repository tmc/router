...
| <a name="return-200-at-root"></a>deis-router | deployment | [router.deis.io/nginx.return200AtRoot](#return-200-at-root) | `"false"` | Whether or not to turn a 200 for otherwise unhandled requests to `/` |
